...
app.add_middleware(SessionMiddleware, secret_key='fourdays')
    ...
    if not ree.fullmatch(r'[a-zA-Z0-9]{6,}', login):
        ...
        with get_db() as conn:
            ...
            if not user:
                ...
                error = "Логин уже занят" #Эту строчку забыла
...
def get_admin(request: Request,
    ...
    return templates.TemplateResponse(request=request, name="admin.html", context={"requests": request_list})
