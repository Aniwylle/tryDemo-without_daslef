...
# --- ЭТО СОЗДАЕТ ВЕБ-ПРИЛОЖЕНИЕ ---
app = FastAPI()
app.add_middleware(SessionMiddleware, secret_key="Banana") # ВКЛЮЧАЕТ СИСТЕМУ СЕССИЙ
templates = Jinja2Templates(directory="templates")
# --- ЭТО СОЗДАЕТ ВЕБ-ПРИЛОЖЕНИЕ ---

# --- ЭТО БЛОК БАЗЫ ДАННЫХ ---
...
# --- ЭТО ЗАПРОСЫ ПРИ ПЕРЕХОДЕ ПО ССЫЛКЕ ---
@app.get("/register")
...
# --- А ЭТА ХУЙНЯ С ЗАПРОСАМИ КОГДА ИДЕТ ОТПРАВКА ФОРМЫ ---
@app.post("/register")
